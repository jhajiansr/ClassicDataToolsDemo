       ...
       program-id. Program1 as "ConduitPractice.Program1".
       ...
       File-control.
           ...
           Select  tfilename 
           assign to ConduitPractice Access Mode is Sequential.
       ...
       FD tfilename.
           ...
           EX-ADDITIONAL-LEAVE pic 9(3) comp.
       ...
       01 ttfilename string value "C:\Users\jhaji\source\repos\ConduitPractice\datavseq.dat".
       01 anykey pic x(80).
      
           exec sql begin declare section end-exec
           01 employeerec pic x(80).
           01 employeename  pic x(80).
           exec sql end declare end-exec
       procedure division.
           
      *    open i-o tfilename.
           exec sql  select employeerec into :employeerec  from ttfilename where employeename = 'MR. KROHN' end-exec.
           display employeerec.
